...
var gui = new dat.GUI();
var hgui = gui.addFolder("Forces");
var pgui = gui.addFolder("Particles");
var wgui = gui.addFolder("World");
hgui.add(settings, "frictionLimit").name("Friction limit");
hgui.add(settings, "frictionMultip").name("Friction multiplier");
hgui.add(settings, "strongForce").name("Strong force");
hgui.add(settings, "hookRange").name("Hook range");
hgui.add(settings, "hookSpeed").name("Hook speed");
hgui.add(settings, "hookStrength").name("Hook strength");
pgui.add(settings, "speedLimit").name("Speed limit");
pgui.add(settings, "speedSizing",0,3,1).name("Speed sizing");
pgui.add(settings, "maxSize").name("Max size");
wgui.add(settings, "count").name("Inital count");
wgui.add(settings, "maxCount").name("Max count");
wgui.add(settings, "mode",0,2,1).name("Wrapping mode");
pgui.add(settings, "newChance").name("New chance");
pgui.add(settings, "puberty").name("Puberty age");
pgui.add(settings, "death").name("Death age");
hgui.add(settings, "clickForce").name("Click force");
hgui.add(settings, "clickRange").name("Click range");